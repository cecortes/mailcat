...
1. **Delegación de Responsabilidad:** Antes de intentar escribir código para un componente frontend de forma independiente, debes **siempre** consultar y seguir la skill definida en el archivo `.agent/skills/apply_mvc_pattern/SKILL.md`.
